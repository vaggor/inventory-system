              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('locations.edit', $location->id) }}" class="btn btn-info btn-sm">Edit</a>
                        <button type="button" 
                  ...
                  <!-- Delete Confirmation Modal -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form id="deleteForm" method="POST" action="{{ route('locations.destroy', $location->id) }}">
                                        @csrf
                                        @method('DELETE')
                    ...
                    <script>
                        const deleteModal = document.getElementById('deleteLocationModal{{ $location->id }}');
